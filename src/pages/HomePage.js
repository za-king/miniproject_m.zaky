        ...
        <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1">
          <div className="w-full h-full flex flex-col justify-center items-center">
            ...
            <div className="flex mt-12">
              <Fade left><button className="bg-black w-40 h-12 hover:bg-inherit hover:border-2 hover:border-black hover:text-black hover:shadow-2xl rounded-full text-white text-center align-middle mr-4 border-orange-600">
                Get Started
              </button></Fade>
